...
#Paso1
library("readxl")
densidad_parcelas <- read_excel("D:/chris/Documents/GitHub/ecologia_vegetal/data/conteo_taraxacum_1m.xlsx", sheet = "Hoja2", col_types = c("numeric","numeric"))

View(densidad_parcelas)
```
